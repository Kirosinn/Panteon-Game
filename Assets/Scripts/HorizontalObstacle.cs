...
public class HorizontalObstacle : MonoBehaviour
{
	...
	public float distance = 0.35f; //Engelin hangi mesafe de hareket edeceği
	...
	void Start()
	{
		//Aşağıda ki kod satırlarda engelin tekrarlanan hareketinin fonksiyonları yazılmıştır.
